...
import 'package:senior_platform_authentication_ui/src/presentation/key_authentication/widgets/access_key_form.dart';
...
void main() {
  ...
  group('AccessKeyForm', () {
    ...
    testWidgets('should render correctly test', (tester) async {
      ...
      final accessKeyTextFieldFinder = find.byWidgetPredicate((widget) =>
          widget is SeniorTextField && widget.prefixIcon == FontAwesomeIcons.key);

      await tester.enterText(accessKeyTextFieldFinder, 'key');
      await tester.pumpAndSettle();
      expect(accessKeyTextFieldFinder, findsOneWidget);
    });
  });
}
