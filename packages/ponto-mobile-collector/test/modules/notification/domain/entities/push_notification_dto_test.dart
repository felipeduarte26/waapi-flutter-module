...
void main() {
  ...
  group('PushNotificationDto', () {
    test('fromJson should return a valid instance', () {
      ...
      // Act
      final dto = PushNotificationDto.fromJson(json);

      // Assert
      expect(dto.messages.length, 1);
      final message = dto.messages.first;
      expect(message.id, '123');
      expect(message.title, 'Test Title');
      expect(message.messageContent, 'Test Content');
      expect(message.createdAt, DateTime.parse('2023-10-05T14:48:00.000Z'));
      expect(message.read, true);
    });

    test('toJson should return a valid map', () {
      // Arrange
      final message = PushMessageEntity(
        id: '123',
        title: 'Test Title',
        messageContent: 'Test Content',
        createdAt: DateTime.parse('2023-10-05T14:48:00.000Z'),
      ...
      final dto = PushNotificationDto(messages: [message]);
