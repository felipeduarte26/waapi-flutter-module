...
import 'vacation_detail_attachments_model.dart';
import 'vacation_signature_data_model.dart';

class VacationDetailModel extends Equatable {
  final String? id;
  ...
  final List<VacationDetailAttachmentsModel>? attachments;
  final String? commentary;
  final String? approverCommentary;
  final String? integrationErrorMessage;
  final String? reportLink;
  final String? reportVacationNoticeLink;
  final VacationSignatureDataModel? vacationReceiptSignatureData;
  final VacationSignatureDataModel? vacationNoticeSignatureData;

  const VacationDetailModel({
    this.id,
    this.vacationDays,
