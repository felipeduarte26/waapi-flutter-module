...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new br.com.gryfo.flutter_gryfo_lib.FlutterGryfoLibPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_gryfo_lib, br.com.gryfo.flutter_gryfo_lib.FlutterGryfoLibPlugin", e);
    }
    try {
